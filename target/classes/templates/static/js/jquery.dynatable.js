...
(function($) {
  ...
  function defaultCellWriter(column, record) {
    ...
    if (column.hidden /*|| column.textAlign njohnson 03/02/16*/) {
      td += ' style="';
    ...
    this.create = function(cell) {
      var $cell = $(cell),
          $link = $('<a></a>', {
            ...
            href: '#/',   //Gennady added / to get rid of jumping when sorted 
            html: $cell.html()
          }),
  ...
  function PaginationPerPage(obj, settings) {
    ...
    this.create = function() {/*njohnson add class small-width 2/17*/
      var $select = $('<select class="small-width" >', {
          ...
          if (attr == "queries" && data[label]) {
            ...
            for (var i = 0, len = inputQueries.length; i < len; i++) {
              ...
              if (data[label][attr]) {
            	...
            	//Gennady added this to get rid of annoying undefined errors in Javascript
            	if (urlOptions[label] != 'undefined' && urlOptions[label] != null) {
